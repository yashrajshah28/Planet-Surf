...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Welcome To Planet Surf</div>
...
<section class="page-section" id="contact">
	<div class="container">
		...
		<div class="text-center">
			...
			<h3 class="section-subheading text-muted">Subscribe for get latest news and offers</h3>

			<form id="newsletter">
				<div class="row align-items-center mb-0 justify-content-center"> <!-- Added justify-content-center -->
					<div class="col-md-6">
						<!-- Email address input-->
						<input class="form-control" id="email" name="email" type="email" placeholder="Your Email *" data-sb-validations="required,email" />
						<div class="text-center mt-3"> <!-- Changed text-right to text-center -->
							<button class="btn btn-primary btn-xl text-uppercase" id="submitButton" type="submit">Sign up</button>
						</div>
					</div>
				</div>
			</form>
...
<script>
	$(function() {
		$('#contactForm', '#newsletter').submit(function(e) {
			e.preventDefault()
			$.ajax({
